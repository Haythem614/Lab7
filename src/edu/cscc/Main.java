...
public class Main {
    ...
    /** This method promps the user to enter a choice and then a computer chooses something
     *  then outputs the choices and tells the user who won and asks if they want to play again
     * @param args
     */
